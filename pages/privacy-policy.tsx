...
const PrivacyPolicy: React.FC = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy - ChatGPT No Login</title>
        <meta
          name="description"
          content="We value your privacy at ChatGPT No Login."
        />
        <meta name="keywords" content="ChatGPT, No Login, Chatbot, AI" />
        ...
        <main className="flex-grow p-10">
          <section className="container mx-auto">
            ...
            <p className="text-lg mb-4">
              ...
              processing, data analysis, and marketing. We may also disclose
              your information if required by law or to protect our rights or
            ...
            <p className="text-lg mb-4">
              ...
              emails. When using our service, you also agree to the OpenAI
            ...
            <p className="text-lg mb-4">
              ...
              any material changes, we will notify you by posting a notice on
              our website or by sending you an email.
            </p>
