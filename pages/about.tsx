...
const AboutUs: React.FC = () => {
  return (
    <>
      <Head>
        <title>About Us - ChatGPT No Login</title>
        <meta
          name="description"
          content="Learn more about ChatGPT No Login, a platform that makes ChatGPT accessible without any login requirements."
        />
          ...
          <section className="container mx-auto">
            ...
            <div className="bg-light-green text-white rounded-lg p-8 mb-8">
              ...
              <p className="text-lg">
                ...
                experience the capabilities of ChatGPT without the hassle of
                logging in or going through complicated setups. That&apos;s why
                we created ChatGPT No Login.
              </p>
            </div>
